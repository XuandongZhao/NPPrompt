...
class FinRE(CLSProcessor):
    ...
    def __init__(self):
        super().__init__(
            ...
            labels_mapped=[
                "无关系", "注资", "拥有", "纠纷", "同一个", "增持", "重组", "买资", "签约", "持股", "交易", "入股", "转让", "成立", "分析", "合作", "帮助", "发行", "商讨", "合并", "竞争", "订单", "减持", "合资", "收购", "借壳", "欠款", "被发行", "被转让", "被成立", "被注资", "被持股", "被拥有",
                "被收购", "被帮助", "被借壳", "被买资", "被欠款", "被增持", "拟收购", "被减持", "被分析", "被入股", "被拟收购",
            ]
        )
